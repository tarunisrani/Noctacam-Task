package com.tarunisrani.noctacam.activities;
...
import com.tarunisrani.noctacam.R;
import com.tarunisrani.noctacam.adapter.ImageListAdapter;
import com.tarunisrani.noctacam.helper.NetworkCall;
import com.tarunisrani.noctacam.helper.NetworkCallListener;
import com.tarunisrani.noctacam.listeners.ImageListClickListener;
import com.tarunisrani.noctacam.listeners.NetworkResponseListener;
import com.tarunisrani.noctacam.utils.AppUtils;
import com.tarunisrani.noctacam.utils.String_Constants;
    ...
    private void showImage(JSONObject jsonObject){
        ...
        if(jsonObject!=null) {
            ...
            try {
                ...
                Log.e("showImage", "Next Cursor"+mNextCursor);
